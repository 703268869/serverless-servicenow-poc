// from https://github.com/getndazn/dazn-lambda-powertools/blob/master/packages/lambda-powertools-dynamodb-client/index.js
...
// const dax = new AmazonDaxClient({endpoints: ['dax-hrms-cluster.huafqb.clustercfg.dax.aps1.cache.amazonaws.com:8111']});
...
client.batchWriteWithCorrelationIds = (correlationIds, params, ...args) => {
  ...
  tableNames.forEach((tableName) => {
    const newReqs = params.RequestItems[tableName].map((req) => {
      const newReq: ParamSetInterface = {};
